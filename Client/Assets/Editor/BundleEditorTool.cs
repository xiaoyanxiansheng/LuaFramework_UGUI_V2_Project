...
public class BundleEditorTool {
    ...
    {
        string[] assetPaths = Directory.GetFiles(PathDefines.S_BundleExportPath, "*.*", SearchOption.AllDirectories);
    ...
    public static string GetABName(string assetName) 
    {
        ...
        string mergePath = PathDefines.S_BundleExportPath + directPath + "/merge.txt";
